...
import {Box, Typography, Alert, Card, Divider, Button, Stack, Chip} from "@mui/material"
...
export default function FlightReview({offer, pricingResponse, onContinue}: Props) {
                                    ...
                                    <Box key={i}>
                                        ...
                                        >
                                            <Box display={{xs: "flex", sm: "block"}} justifyContent="space-between"
                                                ...
                                                <Stack direction="row" spacing={1} flexWrap="wrap" mt={{sm: 1}}>
                                            ...
                                            <Stack direction="row" justifyContent="space-between" alignItems="center"
                                                   spacing={0.75} width={{xs: "100%", sm: "auto"}}>
                                                {/* Departure */}
                                                <Box>
                ...
                <Card sx={{mt: 3, p: {xs: 1.5, sm: 2}}}>
                    ...
                    <Stack spacing={0.75}>
                        ...
                        <Box display="flex" justifyContent="space-between">
                            ...
                            <Typography>{(Number(price.grandTotal) - Number(price.base)).toFixed(2)}</Typography>
                        </Box>
